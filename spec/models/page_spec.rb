...
RSpec.describe Page, type: :model do
  ...
  describe ".month_year_list" do
    ...
    before do
      ...
      create(:page, :published, created_at: Date.new(2022, 8, 10)) # distinct by month, year
      create(:page, :published, created_at: Date.new(2022, 8, 11)) # distinct by month, year

      create(:page, :published, created_at: Date.new(2021, 3, 13))
    end

    it "returns a list of results" do
      expect(result.count).to eq(2) # distinct by month, year
    end
